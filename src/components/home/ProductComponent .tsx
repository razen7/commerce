  ...
  return (
    <div className='flex-1 flex min-w-[320px] h-[200px] border-2'>
      <div className='flex-1 flex content-center items-center'>
        <img src={product.image} alt={product.title} className='max-h-full max-w-full p-2' />
      </div>
      <div className="flex-1 relative">
        ...
        <div className='mt-4 absolute top-[50%] ml-1'>
          <button className='border-2 rounded-lg p-2 bg-slate-300 hover:bg-inherit transition-all duration-500' onClick={()=>router.push('/product/'+ product.id)}>
